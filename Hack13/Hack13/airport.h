 ...
 */
int cmpByGPSId(const void* a, const void* b); //done

/**
 * A comparator function that orders the two Airport structures by
 * their type.
 */
int cmpByType(const void* a, const void* b); //done

/**
 * A comparator function that orders the two Airport structures by
 * their name in lexicographic order.
 */
int cmpByName(const void* a, const void* b);  //done

/**
 * A comparator function that orders the two Airport structures by
 * their name in reverse lexicographic order.
 */
int cmpByNameDesc(const void* a, const void* b); //done

/**
 * A comparator function that orders the two Airport structures first by
 * country, then by city
 */
int cmpByCountryCity(const void* a, const void* b); //done

/**
 * A comparator function that orders the given Airport structures
 * by their latitudes north to south
 */
int cmpByLatitude(const void* a, const void* b); //done

/**
 * A comparator function that orders the given Airport structures
 * by their longitudes west to east
 */
int cmpByLongitude(const void* a, const void* b); //done
 ...
 */
int cmpByLincolnDistance(const void* a, const void* b);  //done
...
/**
 * Prints out information taken from an array of airport stuctures
 */
void printAirports(const Airport *airports, int n);

/**
 * Prints out information on a single selected airport
 */
